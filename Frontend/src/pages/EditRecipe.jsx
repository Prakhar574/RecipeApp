...
import '../components/editRecipe.css' // Importing separate CSS for styling
...
export default function EditRecipe() {
    ...
    useEffect(() => {
        const getData = async () => {
            await axios.get(`https://recipe-app-nu-snowy.vercel.app/recipe/${id}`)
                .then(response => {
    ...
    const onHandleSubmit = async (e) => {
        ...
        await axios.put(`https://recipe-app-nu-snowy.vercel.app/recipe/${id}`, recipeData, {
            headers: {
